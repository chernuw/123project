...
var maps = ["Алетаракский Перевал", "Башни рока", "Бойня на браксисе", "Вечная битва", "Гробница королевы пауков", "Драконий край", "Завод Вольской", 
	   "Небесный храм", "Осквернённое святилище", "Призрачные копи", "Проклятая лощина", "Сад ужасов", "Ядерный полигон"];
var heroes = ["Абатур","Азмодан","Аларак","Алекстраза","Ана","Ануб’арак","Артанис","Артас","Ауриэль","Блэйз","Вайтмейн","Валира","Валла","Вариан",
	      "Газлоу","Гаррош","Гул’дан","Гэндзи","Декард","Дехака","Джайна", "Джоанна","Диабло","D.Va","E.T.C.","Загара","Заря","Зератул",
	      "Зул","Зул’джин","Иллидан","Ирель","Каразим","Кассия","Кел'Тузад","Кель’тас","Керриган","Крысавчик","Лейтенант Моралес","Леорик",
