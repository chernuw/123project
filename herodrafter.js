...
var heroes = ["Абатур","Азмодан","Аларак","Алекстраза","Ана","Ануб’арак","Артанис","Артас","Ауриэль","Блэйз","Валира","Валла","Вариан",
	      ...
	      "Зул","Иллидан","Каразим","Кассия","Кел'Тузад","Кель’тас","Керриган","Крысавчик","Лейтенант Моралес","Леорик","Ли Ли",
	      "Ли-Мин","Лунара","Лусио","Майев","Малтаэль","Малфурион","Медив","Мурадин","Мурчаль","Мясник","Назибо","Нова",
